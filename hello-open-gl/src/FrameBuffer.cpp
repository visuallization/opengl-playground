...
void FrameBuffer::AttachRenderBuffer(RenderBuffer* renderBuffer) const {
	GLCall(glFramebufferRenderbuffer(GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_RENDERBUFFER, renderBuffer->GetID()));
}
